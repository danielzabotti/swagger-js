...
var _startsWith = __webpack_require__(18);
...
function isOAS3(spec) {
  ...
  return (0, _startsWith2.default)(oasVersion, '3');
}
...
function isSwagger2(spec) {
  ...
  return (0, _startsWith2.default)(swaggerVersion, '2');
}
...
exports.shouldDownloadAsText = exports.self = undefined;
...
var _qs = __webpack_require__(54);

var _qs2 = _interopRequireDefault(_qs);

var _jsYaml = __webpack_require__(46);
...
var self = exports.self = {
  ...
  return (request.userFetch || fetch)(request.url, request).then(function (res) {
...
var shouldDownloadAsText = exports.shouldDownloadAsText = function shouldDownloadAsText() {
...
function parseBody(body, contentType) {
  ...
  return _jsYaml2.default.safeLoad(body);
}
...
function mergeInQueryOrForm() {
  ...
  if (form) {
    ...
    if (hasFile || /multipart\/form-data/i.test(contentType)) {
      var FormData = __webpack_require__(45); // eslint-disable-line global-require
...
var _fastJsonPatch = __webpack_require__(44);
...
var _deepExtend = __webpack_require__(42);
...
function applyPatch(obj, patch, opts) {
  ...
  if (patch.op === 'merge') {
    ...
    var origValPatchValue = (0, _assign2.default)({}, _valPatch.value);
    ...
    for (var prop in patch.value) {
      if (Object.prototype.hasOwnProperty.call(patch.value, prop)) {
        ...
        if (Array.isArray(propVal)) {
          var existing = origValPatchValue[prop] || [];
          _valPatch.value[prop] = existing.concat(propVal);
        }
      }
    }
  } else {
...
var _cloneDeep = __webpack_require__(47);
...
var _resolver = __webpack_require__(27);

var _resolver2 = _interopRequireDefault(_resolver);

var _interfaces = __webpack_require__(26);
...
var _assign3 = __webpack_require__(7);
...
var _btoa = __webpack_require__(9);
...
var _createError = __webpack_require__(11);

var _createError2 = _interopRequireDefault(_createError);

var _parameterBuilders = __webpack_require__(25);

var _parameterBuilders2 = _interopRequireDefault(_parameterBuilders);

var _parameterBuilders3 = __webpack_require__(22);

var _parameterBuilders4 = _interopRequireDefault(_parameterBuilders3);

var _buildRequest = __webpack_require__(21);

var _buildRequest2 = _interopRequireDefault(_buildRequest);

var _buildRequest3 = __webpack_require__(24);

var _buildRequest4 = _interopRequireDefault(_buildRequest3);
...
var OperationNotFoundError = (0, _createError2.default)('OperationNotFoundError', function (message, extra, oriError) {
...
function buildRequest(options) {
  ...
  var specIsOAS3 = (0, _helpers.isOAS3)(spec);

  if (!parameterBuilders) {
    // user did not provide custom parameter builders
    if (specIsOAS3) {
      parameterBuilders = _parameterBuilders4.default;
    } else {
      parameterBuilders = _parameterBuilders2.default;
    }
  }

  // Base Template
  var req = {
    url: baseUrl({ spec: spec, scheme: scheme, contextUrl: contextUrl, server: server, serverVariables: serverVariables }),
  ...
  var operationRaw = (0, _helpers.getOperationRaw)(spec, operationId);
  if (!operationRaw) {
    throw new OperationNotFoundError('Operation ' + operationId + ' not found');
  }

  var _operationRaw$operati = operationRaw.operation,
      operation = _operationRaw$operati === undefined ? {} : _operationRaw$operati,
  ...
  var combinedParameters = [].concat(arrayOrEmpty(operation.parameters)) // operation parameters
  ...
  var versionSpecificOptions = (0, _extends3.default)({}, options, { operation: operation });

  if (specIsOAS3) {
    req = (0, _buildRequest2.default)(versionSpecificOptions, req);
  } else {
    // If not OAS3, then treat as Swagger2.
    req = (0, _buildRequest4.default)(versionSpecificOptions, req);
  }

  // If the cookie convenience object exists in our request,
  // serialize its content and then delete the cookie object.
  if (req.cookies && (0, _keys2.default)(req.cookies).length) {
    var cookieString = (0, _keys2.default)(req.cookies).reduce(function (prev, cookieName) {
      var cookieValue = req.cookies[cookieName];
      var prefix = prev ? '&' : '';
      var stringified = _cookie2.default.serialize(cookieName, cookieValue);
...
function baseUrl(obj) {
  var specIsOAS3 = (0, _helpers.isOAS3)(obj.spec);
...
function oas3BaseUrl(_ref2) {
  var spec = _ref2.spec,
      ...
      serverVariables = _ref2$serverVariables === undefined ? {} : _ref2$serverVariables;
...
function swagger2BaseUrl(_ref3) {
  var spec = _ref3.spec,
      ...
      contextUrl = _ref3$contextUrl === undefined ? '' : _ref3$contextUrl;
...
exports.default = function (options, req) {
...
function applySecurities(_ref) {
  var request = _ref.request,
      ...
      securities = _ref$securities === undefined ? {} : _ref$securities,
...
var _styleSerializer = __webpack_require__(23);

var _styleSerializer2 = _interopRequireDefault(_styleSerializer);
...
function query(_ref2) {
  ...
  if (value) {
    ...
    } else if (type === 'object' && !Array.isArray(value) && (parameter.style === 'form' || !parameter.style) && (parameter.explode || parameter.explode === undefined)) {
...
function cookie(_ref4) {
  ...
  if (type !== 'undefined') {
    var prefix = type === 'object' && !Array.isArray(value) && parameter.explode ? '' : parameter.name + '=';
...
var _encode = __webpack_require__(43);
...
function encodeArray(_ref) {
  ...
  var valueEncoder = escape ? function (a) {
    return (0, _encode2.default)(a);
  } : function (a) {
    return a;
  };
  ...
  if (style === 'form') {
    var commaValue = escape ? escapeFn(',') : ',';
    var after = explode ? '&' + key + '=' : commaValue;
    return value.map(function (val) {
      return valueEncoder(val);
    }).join(after);
  }
  ...
  if (style === 'spaceDelimited') {
    ...
    return value.map(function (val) {
      return valueEncoder(val);
    }).join('' + escapeFn(' ') + _after);
  }

  if (style === 'pipeDelimited') {
    var _after2 = explode ? key + '=' : '';
    var separator = escape ? escapeFn('|') : '|';
    return value.map(function (val) {
      return valueEncoder(val);
    }).join('' + separator + _after2);
  }
}
...
var _pick = __webpack_require__(53);
  ...
  return function (_ref) {
    ...
    return function (parameters) {
      ...
      return swaggerJs.execute((0, _extends3.default)({
        spec: swaggerJs.spec
      }, (0, _pick2.default)(swaggerJs, 'requestInterceptor', 'responseInterceptor', 'userFetch'), {
        pathName: pathName,
        method: method,
        parameters: parameters,
...
var _specmap = __webpack_require__(28);
...
function resolve(obj) {
  var fetch = obj.fetch,
      ...
      allowMetaPatches = _obj$allowMetaPatches === undefined ? true : _obj$allowMetaPatches,
...
var _allOf = __webpack_require__(29);

var _allOf2 = _interopRequireDefault(_allOf);

var _parameters = __webpack_require__(31);

var _parameters2 = _interopRequireDefault(_parameters);

var _properties = __webpack_require__(32);

var _properties2 = _interopRequireDefault(_properties);

var _contextTree = __webpack_require__(30);
  ...
  (0, _createClass3.default)(SpecMap, [{
    ...
    value: function wrapPlugin(plugin, name) {
      ...
      function createKeyBasedPlugin(pluginObj) {
        return (/*#__PURE__*/_regenerator2.default.mark(function _callee(patches, specmap) {
                ...
                switch (_context2.prev = _context2.next) {
                  case 0:
                    traverse = function traverse(obj, path, patch) {
                      var parentIndex, parent, indexOfFirstProperties, isRootProperties, _iteratorNormalCompletion2, _didIteratorError2, _iteratorError2, _iterator2, _step2, key, val, updatedPath;
                        ...
                        while (1) {
                          switch (_context.prev = _context.next) {
                            ...
                            case 15:
                              ...
                              return _context.delegateYield(traverse(val, updatedPath, patch), 't0', 21);
                      ...
                      }, _marked, this, [[13, 29, 33, 41], [34,, 36, 40]]);
                    };

                    _marked = /*#__PURE__*/_regenerator2.default.mark(traverse);
    ...
    value: function nextPlugin() {
      ...
      return (0, _find2.default)(this.wrappedPlugins, function (plugin) {
...
var _weakMap = __webpack_require__(35);
...
var _crossFetch = __webpack_require__(40);
...
function fetchJSON(docPath) {
  return (0, _crossFetch.fetch)(docPath, { headers: { Accept: 'application/json' }, loadSpec: true }).then(function (res) {
    return res.json();
  });
}
